...
from data.models import Series, AlbumPages
...
def generate_album_pages():  
    ...
    gaps = Gaps(vertical=album_pages.cont_vert_pad, horizontal=album_pages.cont_horiz_pad)
    aligment_options = AligmentOptions(gaps=gaps, horizontal=album_pages.cont_horiz_algmt, vertical=album_pages.cont_vert_algmt)
